const Footer = () => {
	return (
		<footer className='flex  flex-col lg:flex-row h-full z-10 text-xs px-10 sm:px-20 md:px-20 lg:px-20 xl:32px 2xl:40px 3xl:60px 4xl:px-80 py-16 bg-footer border-t-header gap-24'>
