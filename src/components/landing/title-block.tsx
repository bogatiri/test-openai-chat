...
const TitleBlock = () => {
	return (
		<div className='grid px-10 sm:px-20 md:px-20 lg:px-20 xl:32px 2xl:40px 3xl:60px 4xl:px-80 grid-rows-[0.2fr_1.4fr] xl:grid-rows-1 xl:mt-28 xl:grid-cols-[1fr_1.4fr] gap-8'>
